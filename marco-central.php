   ...
   <div  style="width: 100%;  ">     
    <div style="width: 100%; height:100%; margin: auto ; display:inline-block;" >
       <div style=" width:100%; height: 100%; top:0; font-size:20px; text-align:center; float:left; ">
        	<h1>¿Quién es Maila Muñoz Pablo R.?</h1>
       		 <hr>
             
          <div id="posteo" style="text-align: left; font-size:0.5vw;">
                Posteado por:  Maila Pablo<br>
                Fecha: 2023-04-30 <br>
          </div>
        </div>
    </div>
...
<p class="eys-parrafo">Mis metas son obtener una maestria en el area de redes y hasta un doctorado ya que mis aspiraciones profesionales son altamente grandes para asi mismo crecer y avanzar como profesional y obtener un mejor puesto de trabajo y obviamente una remuneracion y estilos de vida mejor.</p>
   <div id="blog-seccion3"  style="height: 50px;"></div>
    ...
    <h2 style="border-bottom: 1px solid green;"> Mi perfil informático</h2> 
                   ...
                   <p  class="eys-parrafo">Mi perfil tecnológico es orientado a las redes, me atraen mucho los cableados y distintos de protocolos que se utilizan en las diferentes encriptaciones, topologias, cav+bleados y estructuras que se presenten en las mismas.o.</p> 
                   <p  class="eys-parrafo">Hoy en día sigo aprendiendo y sigo practicando para lograr ser un buen profesional y tener un concoimiento superior sobre las redes que son la parte que mas me atraen de la carrera.</p>
